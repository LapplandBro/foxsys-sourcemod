...
public Plugin:myinfo = {
	...
	description = "Main navigation menu in a VSH Server",
	version = VERSION,
	url = URL
}
	...
	if (action == MenuAction_Select)
	{
		...
		switch (StringToInt(info))
		{
				...
				case 7:
			{
				...
				case 8:
			{
				MC_PrintToChat(client, "{#7366bd}[Справка]{default} Cообщество в Discord: {#7366bd}https://discord.gg/ZwbrJk5r9h\n{#7366bd}✦{default} Присоединившись к серверу, укажите свой никнейм Steam.");
			}
				case 11:
			{
