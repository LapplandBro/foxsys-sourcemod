...
public Plugin:myinfo = {
	name        = "[TF2] CCC Toggle Module",
	author      = "Dr. McKay, Mini, Lappland Saluzzo",
	description = "Allows admins to toggle their chat colors",
	version     = PLUGIN_VERSION,
	url         = "http://lurolona.su"
};
